########################################
#
#  Main authors: Michele Selvaggi, Eric Moreno (MIT), Benedikt Maier (ICL),  Ryan Liu (Caltech)
#
#  Released on: December 1st, 2025
#
#  Version: v1.0
#
#  Based on: CMS_PhaseII_200PU_v04.tcl + Custom L1T tune/modules
#
#  Description: This card provides two independent reconstruction views:
#    - Full-Reco: Modern Snowmass tune with high-performance tracking
#    - L1T: Degraded performance matching L1 trigger constraints 
...
set ExecutionPath {
  ...
  L1TChargedHadronTrackingEfficiency
  L1TElectronTrackingEfficiency
  L1TMuonTrackingEfficiency

  L1TChargedHadronMomentumSmearing
  L1TElectronEnergySmearing
  L1TMuonMomentumSmearing
  ...
  L1TPhotonEnergySmearing
  L1TElectronFilter
  
  L1TTrackPileUpSubtractor
  L1TRecoPuFilter

  L1TTowerMerger
  L1TNeutralEFlowMerger

  L1TEFlowMerger
  L1TEFlowMergerCHS
  L1TRho

  L1TLeptonFilterNoLep
  L1TLeptonFilterLep
  L1TRunPUPPIBase
  L1TRunPUPPIMerger
  L1TRunPUPPI
  ...
  L1TPhotonIsolation
  L1TPhotonIsolationCHS
  L1TPhotonEfficiencyCHS

  L1TPhotonLooseID
  L1TPhotonTightID
  
  L1TElectronCloner
  L1TElectronIsolation
  L1TElectronIsolationCHS

  L1TElectronEfficiency
  L1TElectronEfficiencyCHS

  L1TMuonCloner
  L1TMuonIsolation
  L1TMuonIsolationCHS

  L1TMuonLooseIdEfficiency
  L1TMuonTightIdEfficiency

  L1TMuonLooseIdEfficiencyCHS
  L1TMuonTightIdEfficiencyCHS
  ...
  L1TFastJetFinder
  L1TFastJetFinderAK8
  L1TJetPileUpSubtractor
  L1TJetPileUpSubtractorAK8
  L1TFastJetFinderPUPPI
  L1TFastJetFinderPUPPIAK8

  L1TScalarHT

  L1TJetEnergyScale
  L1TJetEnergyScaleAK8
  L1TJetEnergyScalePUPPI
  L1TJetEnergyScalePUPPIAK8

  L1TJetFlavorAssociation
  L1TJetFlavorAssociationAK8
  L1TJetFlavorAssociationPUPPI
  L1TJetFlavorAssociationPUPPIAK8

  L1TBTagging
  L1TBTaggingAK8
  L1TBTaggingPUPPILoose
  L1TBTaggingPUPPIMedium
  L1TBTaggingPUPPITight
  L1TBTaggingPUPPILooseMTD
  L1TBTaggingPUPPIMediumMTD
  L1TBTaggingPUPPITightMTD
  L1TBTaggingPUPPIAK8

  L1TTauTaggingCutBased
  L1TTauTaggingDNNMedium
  L1TTauTaggingDNNTight

  L1TTauTaggingAK8CutBased
  L1TTauTaggingAK8DNNMedium
  L1TTauTaggingAK8DNNTight

  L1TTauTaggingPUPPICutBased
  L1TTauTaggingPUPPIDNNMedium
  L1TTauTaggingPUPPIDNNTight

  L1TTauTaggingPUPPIAK8CutBased
  L1TTauTaggingPUPPIAK8DNNMedium
  L1TTauTaggingPUPPIAK8DNNTight
...
###################
#########################################
#  L1T Charged hadron tracking efficiency
#########################################

module Efficiency L1TChargedHadronTrackingEfficiency {
  ## particles after propagation
  set InputArray  DenseTrackFilter/chargedHadrons
  set OutputArray chargedHadrons
  # tracking efficiency formula for charged hadrons
  set EfficiencyFormula {
      (pt <= 2.0) * (0.00) + \
          (abs(eta) <= 2.4) * (pt > 2 && pt <= 3) * (0.59) + \
          (abs(eta) <= 2.4) * (pt > 3 && pt <= 4) * (0.71) + \
          (abs(eta) <= 2.4) * (pt > 4 && pt <= 5) * (0.76) + \
          (abs(eta) <= 2.4) * (pt > 5 && pt <= 8) * (0.82) + \
          (abs(eta) <= 2.4) * (pt > 8 && pt <= 15) * (0.90) + \
          (abs(eta) <= 2.4) * (pt > 15 && pt <= 25) * (0.92) + \
          (abs(eta) <= 2.4) * (pt > 25) * (0.93) + \
          (abs(eta) > 2.4) * (0.00)
  }
}
...
#####################################
# L1T Electron tracking efficiency - ID
####################################

module Efficiency L1TElectronTrackingEfficiency {
  set InputArray  DenseTrackFilter/electrons
  set OutputArray electrons
  # tracking efficiency formula for electrons
  set EfficiencyFormula {
      (pt <= 2.0) * (0.00) + \
          (abs(eta) <= 2.4) * (pt > 2 && pt <= 3) * (0.42) + \
          (abs(eta) <= 2.4) * (pt > 3 && pt <= 4) * (0.58) + \
          (abs(eta) <= 2.4) * (pt > 4 && pt <= 5) * (0.63) + \
          (abs(eta) <= 2.4) * (pt > 5 && pt <= 8) * (0.71) + \
          (abs(eta) <= 2.4) * (pt > 8 && pt <= 15) * (0.80) + \
          (abs(eta) <= 2.4) * (pt > 15 && pt <= 25) * (0.86) + \
          (abs(eta) <= 2.4) * (pt > 25) * (0.89) + \
          (abs(eta) > 2.4) * (0.00)
  }
}
...
module Efficiency L1TMuonTrackingEfficiency {
  set InputArray DenseTrackFilter/muons
  set OutputArray muons
  # tracking efficiency formula for muons
  set EfficiencyFormula {
      (pt <= 2.0) * (0.00) + \
          (abs(eta) <= 2.4) * (pt > 2 && pt <= 3) * (0.93) + \
          (abs(eta) <= 2.4) * (pt > 3 && pt <= 4) * (0.96) + \
          (abs(eta) <= 2.4) * (pt > 4 && pt <= 5) * (0.97) + \
          (abs(eta) <= 2.4) * (pt > 5 && pt <= 10) * (0.98) + \
          (abs(eta) <= 2.4) * (pt > 10) * (1.00) + \
          (abs(eta) > 2.4) * (0.00)
  }
}
...
module MomentumSmearing L1TChargedHadronMomentumSmearing {
  ## hadrons after having applied the tracking efficiency
  set InputArray  L1TChargedHadronTrackingEfficiency/chargedHadrons
  set OutputArray chargedHadrons
  # resolution formula for charged hadrons ,
...
module EnergySmearing L1TElectronEnergySmearing {
  set InputArray L1TElectronTrackingEfficiency/electrons
  set OutputArray electrons
...
module MomentumSmearing L1TMuonMomentumSmearing {
  set InputArray L1TMuonTrackingEfficiency/muons
  set OutputArray muons
  # resolution formula for muons
  ...
  # for |eta| > 2.8 and pT < 5.0 take measurement from tracking alone taken from
  # http://mersi.web.cern.ch/mersi/layouts/.private/Baseline_tilted_200_Pixel_1_1_1/index.html
  source muonMomentumResolutionL1T.tcl
}
...
module Merger L1TTrackMerger {
# add InputArray InputArray
  add InputArray L1TChargedHadronMomentumSmearing/chargedHadrons
  add InputArray L1TElectronEnergySmearing/electrons
  add InputArray L1TMuonMomentumSmearing/muons
  set OutputArray tracks
}
...
module SimpleCalorimeter L1TECal {
  set ParticleInputArray ParticlePropagator/stableParticles
  set TrackInputArray L1TTrackMerger/tracks
...
module SimpleCalorimeter L1THCal {
  set ParticleInputArray ParticlePropagator/stableParticles
  set TrackInputArray L1TECal/eflowTracks
...
module EnergySmearing L1TPhotonEnergySmearing {
  set InputArray L1TECal/eflowPhotons
  set OutputArray eflowPhotons
...
module PdgCodeFilter L1TElectronFilter {
  set InputArray L1THCal/eflowTracks
  set OutputArray electrons
  set Invert true
  add PdgCode {11}
  add PdgCode {-11}
...
#########################
# L1 track pile-up subtractor  (NEW)
#########################
module TrackPileUpSubtractor L1TTrackPileUpSubtractor {
  # charged-track input straight out of L1THCal
  add InputArray  L1THCal/eflowTracks           eflowTracks
  add InputArray  L1TElectronFilter/electrons   electrons
  add InputArray  L1TMuonMomentumSmearing/muons muons

  set VertexInputArray  PileUpMerger/vertices   ;# same PV collection as offline
  # 10x worse z-resolution formula offline
  set ZVertexResolution {
       (pt < 10.) * (((-0.8*log10(pt)+1.)*(10^(0.5*abs(eta)+1.5))*1e-06)*10) +
       (pt >=10.) * ((0.2*(10^(0.5*abs(eta)+1.5))*1e-06)*10)
  }
}
...
module RecoPuFilter L1TRecoPuFilter {
  set InputArray L1THCal/eflowTracks
#  set InputArray L1TTrackPileUpSubtractor/eflowTracks
  set OutputArray eflowTracks
}
...
module Merger L1TTowerMerger {
# add InputArray InputArray
  add InputArray L1TECal/ecalTowers
  add InputArray L1THCal/hcalTowers
  set OutputArray towers
}
...
module Merger L1TNeutralEFlowMerger {
# add InputArray InputArray
  add InputArray L1TPhotonEnergySmearing/eflowPhotons
  add InputArray L1THCal/eflowNeutralHadrons
  set OutputArray eflowTowers
}
...
module Merger L1TEFlowMerger {
# add InputArray InputArray
  add InputArray L1THCal/eflowTracks
  add InputArray L1TPhotonEnergySmearing/eflowPhotons
  add InputArray L1THCal/eflowNeutralHadrons
  set OutputArray eflow
}
...
module Merger L1TEFlowMergerCHS {
# add InputArray InputArray
  add InputArray L1TRecoPuFilter/eflowTracks
  add InputArray L1TPhotonEnergySmearing/eflowPhotons
  add InputArray L1THCal/eflowNeutralHadrons
  set OutputArray eflow
}
...
module PdgCodeFilter L1TLeptonFilterNoLep {
  set InputArray L1THCal/eflowTracks
#  set InputArray L1TTrackPileUpSubtractor/eflowTracks
  set OutputArray eflowTracksNoLeptons
  set Invert false
...
module PdgCodeFilter L1TLeptonFilterLep {
  set InputArray L1THCal/eflowTracks
#  set InputArray L1TTrackPileUpSubtractor/eflowTracks
  set OutputArray eflowTracksLeptons
  set Invert true
...
module RunPUPPI L1TRunPUPPIBase {
  ## input information
...
module Merger L1TRunPUPPIMerger {
  add InputArray L1TRunPUPPIBase/PuppiParticles
...
module PdgCodeFilter L1TEFlowFilterPuppi {
  set InputArray L1TRunPUPPI/PuppiParticles
  set OutputArray eflow
...
module PdgCodeFilter L1TEFlowFilterCHS {
  set InputArray L1TEFlowMergerCHS/eflow
  set OutputArray eflow
...
module Merger L1TMissingET {
# add InputArray InputArray
#  add InputArray RunPUPPI/PuppiParticles
  add InputArray L1TEFlowMerger/eflow
  set MomentumOutputArray momentum
}

module Merger L1TPuppiMissingET {
  #add InputArray InputArray
...
module FastJetGridMedianEstimator L1TRho {

  set InputArray L1TEFlowMergerCHS/eflow
  #set InputArray L1TTowerMerger/towers
  set RhoOutputArray rho
...
module FastJetFinder L1TFastJetFinder {
#  set InputArray TowerMerger/towers
#  set InputArray L1TEFlowMergerCHS/eflow
  set InputArray L1TEFlowMerger/eflow
...
#module Class Name
module FastJetFinder L1TFastJetFinderAK8 {
#  set InputArray TowerMerger/towers
#  set InputArray L1TEFlowMergerCHS/eflow
  set InputArray L1TEFlowMerger/eflow
...
module JetPileUpSubtractor L1TJetPileUpSubtractor {
  set JetInputArray L1TFastJetFinder/jets
  set RhoInputArray L1TRho/rho
...
module JetPileUpSubtractor L1TJetPileUpSubtractorAK8 {
  set JetInputArray L1TFastJetFinderAK8/jets
  set RhoInputArray L1TRho/rho
...
module FastJetFinder L1TFastJetFinderPUPPI {
#  set InputArray TowerMerger/towers
  set InputArray L1TRunPUPPI/PuppiParticles
...
module FastJetFinder L1TFastJetFinderPUPPIAK8 {
#  set InputArray TowerMerger/towers
  set InputArray L1TRunPUPPI/PuppiParticles
...
module EnergyScale L1TJetEnergyScale {
  set InputArray L1TJetPileUpSubtractor/jets
  set OutputArray jets
...
module EnergyScale L1TJetEnergyScaleAK8 {
  set InputArray L1TJetPileUpSubtractorAK8/jets
  set OutputArray jets
...
module EnergyScale L1TJetEnergyScalePUPPI {
  set InputArray L1TFastJetFinderPUPPI/jets
  set OutputArray jets
...
module EnergyScale L1TJetEnergyScalePUPPIAK8 {
  set InputArray L1TFastJetFinderPUPPIAK8/jets
  set OutputArray jets
...
module PdgCodeFilter L1TPhotonFilter {
  set InputArray L1TPhotonEnergySmearing/eflowPhotons
  set OutputArray photons
  set Invert true
  set PTMin 5.0
  add PdgCode {22}
...
module Cloner L1TMuonCloner {
  set InputArray L1TMuonMomentumSmearing/muons
  set OutputArray muons
}
...
module Cloner L1TElectronCloner {
  set InputArray L1TElectronFilter/electrons
  set OutputArray electrons
}
...
module Cloner L1TPhotonCloner {
  set InputArray L1TPhotonFilter/photons
  set OutputArray photons
}
...
module Isolation L1TPhotonIsolation {

  # particle for which calculate the isolation
  set CandidateInputArray L1TPhotonFilter/photons

  # isolation collection
  set IsolationInputArray L1TEFlowFilterPuppi/eflow
...
module Isolation L1TPhotonIsolationCHS {

  # particle for which calculate the isolation
  set CandidateInputArray L1TPhotonCloner/photons

  # isolation collection
  set IsolationInputArray L1TEFlowFilterCHS/eflow
  set RhoInputArray L1TRho/rho
...
module Efficiency L1TPhotonEfficiencyCHS {

  ## input particles
  set InputArray L1TPhotonIsolationCHS/photons
  ## output particles
  set OutputArray photons
  # set EfficiencyFormula {efficiency formula as a function of eta and pt}
  # efficiency formula for photons
...
module PhotonID L1TPhotonLooseID {

  ## input particles
  set InputPhotonArray L1TPhotonIsolation/photons
...
module PhotonID L1TPhotonTightID {
...
module Isolation L1TElectronIsolation {

  set CandidateInputArray L1TElectronFilter/electrons
...
module Isolation L1TElectronIsolationCHS {

  set CandidateInputArray L1TElectronCloner/electrons
...
module Efficiency L1TElectronEfficiency {

  set InputArray L1TElectronIsolation/electrons
  set OutputArray electrons
...
module Efficiency L1TElectronEfficiencyCHS {

  set InputArray L1TElectronIsolationCHS/electrons
  set OutputArray electrons
...
module Isolation L1TMuonIsolation {
  set CandidateInputArray L1TMuonMomentumSmearing/muons
...
module Isolation L1TMuonIsolationCHS {
  set CandidateInputArray L1TMuonCloner/muons
...
module Efficiency L1TMuonLooseIdEfficiency {
    set InputArray L1TMuonIsolation/muons
    set OutputArray muons
    # tracking + LooseID efficiency formula for muons
    source muonLooseId.tcl
...
module Efficiency L1TMuonTightIdEfficiency {
    set InputArray L1TMuonIsolation/muons
    set OutputArray muons
    # tracking + TightID efficiency formula for muons
    #source muonTightId.tcl
...
module Efficiency L1TMuonLooseIdEfficiencyCHS {
    set InputArray L1TMuonIsolationCHS/muons
    set OutputArray muons
    # tracking + LooseID efficiency formula for muons
    source muonLooseId.tcl
...
module Efficiency L1TMuonTightIdEfficiencyCHS {
    set InputArray L1TMuonIsolationCHS/muons
    set OutputArray muons
    # tracking + TightID efficiency formula for muons
    #source muonTightId.tcl
...
module JetFlavorAssociation L1TJetFlavorAssociation {

  set PartonInputArray Delphes/partons
  set ParticleInputArray Delphes/allParticles
  set ParticleLHEFInputArray Delphes/allParticlesLHEF
  set JetInputArray L1TJetEnergyScale/jets
...
module JetFlavorAssociation L1TJetFlavorAssociationAK8 {

  set PartonInputArray Delphes/partons
  set ParticleInputArray Delphes/allParticles
  set ParticleLHEFInputArray Delphes/allParticlesLHEF
  set JetInputArray L1TJetEnergyScaleAK8/jets
...
module JetFlavorAssociation L1TJetFlavorAssociationPUPPI {

  set PartonInputArray Delphes/partons
  set ParticleInputArray Delphes/allParticles
  set ParticleLHEFInputArray Delphes/allParticlesLHEF
  set JetInputArray L1TJetEnergyScalePUPPI/jets
...
module JetFlavorAssociation L1TJetFlavorAssociationPUPPIAK8 {

  set PartonInputArray Delphes/partons
  set ParticleInputArray Delphes/allParticles
  set ParticleLHEFInputArray Delphes/allParticlesLHEF
  set JetInputArray L1TJetEnergyScalePUPPIAK8/jets
...
module BTagging L1TBTaggingAK8 {
...
module BTagging L1TBTaggingPUPPILoose {
...
module BTagging L1TBTaggingPUPPIMedium {
...
module BTagging L1TBTaggingPUPPITight {
...
module BTagging L1TBTaggingPUPPILooseMTD {
...
module BTagging L1TBTaggingPUPPIMediumMTD {
...
module BTagging L1TBTaggingPUPPITightMTD {
...
module BTagging L1TBTaggingPUPPIAK8 {
...
module TauTagging L1TTauTaggingCutBased {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScale/jets
...
module TauTagging L1TTauTaggingDNNMedium {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScale/jets
...
module TauTagging L1TTauTaggingDNNTight {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScale/jets
...
module TauTagging L1TTauTaggingAK8CutBased {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScaleAK8/jets
...
module TauTagging L1TTauTaggingAK8DNNMedium {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScaleAK8/jets
...
module TauTagging L1TTauTaggingAK8DNNTight {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScaleAK8/jets
...
module TauTagging L1TTauTaggingPUPPICutBased {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScalePUPPI/jets
...
module TauTagging L1TTauTaggingPUPPIDNNMedium {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScalePUPPI/jets
...
module TauTagging L1TTauTaggingPUPPIDNNTight {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScalePUPPI/jets
...
module TauTagging L1TTauTaggingPUPPIAK8CutBased {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScalePUPPIAK8/jets
...
module TauTagging L1TTauTaggingPUPPIAK8DNNMedium {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScalePUPPIAK8/jets
...
module TauTagging L1TTauTaggingPUPPIAK8DNNTight {
  set ParticleInputArray Delphes/allParticles
  set PartonInputArray Delphes/partons
  set JetInputArray L1TJetEnergyScalePUPPIAK8/jets
...
#  add Branch HCal/eflowNeutralHadrons EFlowNeutralHadron Tower
  ...
  add Branch RunPUPPIMerger/PuppiParticles EFlowPuppi ParticleFlowCandidate

  add Branch EFlowMerger/eflow EFlow ParticleFlowCandidate
#  add Branch EFlowMergerCHS/eflow EFlowCHS ParticleFlowCandidate
  ...
  add Branch L1THCal/eflowTracks L1TEFlowTrack Track
  add Branch L1TECal/eflowPhotons L1TEFlowPhoton Tower
...
#  add Branch L1TEFlowMergerCHS/eflow L1TEFlowCHS ParticleFlowCandidate
  ...
  add Branch L1TPhotonLooseID/photons L1TPhotonLoose Photon
  add Branch L1TPhotonTightID/photons L1TPhotonTight Photon

  add Branch L1TElectronEfficiency/electrons L1TElectron Electron
  add Branch L1TMuonLooseIdEfficiency/muons L1TMuonLoose Muon
  add Branch L1TMuonTightIdEfficiency/muons L1TMuonTight Muon

  add Branch L1TPhotonEfficiencyCHS/photons L1TPhotonCHS Photon
  add Branch L1TElectronEfficiencyCHS/electrons L1TElectronCHS Electron
  add Branch L1TMuonLooseIdEfficiencyCHS/muons L1TMuonLooseCHS Muon
  add Branch L1TMuonTightIdEfficiencyCHS/muons L1TMuonTightCHS Muon

  add Branch L1TJetEnergyScale/jets L1TJet Jet
  add Branch L1TJetEnergyScalePUPPI/jets L1TJetPUPPI Jet
  add Branch L1TJetEnergyScaleAK8/jets L1TJetAK8 Jet
  add Branch L1TJetEnergyScalePUPPIAK8/jets L1TJetPUPPIAK8 Jet

  add Branch L1TRho/rho L1TRho Rho

  add Branch L1TMissingET/momentum L1TMissingET MissingET
  add Branch L1TPuppiMissingET/momentum L1TPuppiMissingET MissingET
  add Branch L1TScalarHT/energy L1TScalarHT ScalarHT
